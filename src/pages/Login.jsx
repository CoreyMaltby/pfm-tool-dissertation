...
const uiTheme = {
    ...
    primaryAction: "w-full inline-flex items-center justify-center gap-2 px-8 py-4 bg-accent-main text-white font-black rounded-xl shadow-md shadow-accent-main/30 hover:scale-105 transition-transform text-sm disabled:opacity-70 disabled:hover:scale-100",
};
